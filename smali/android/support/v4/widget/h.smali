...
.method public static a(Landroid/widget/ImageView;)Landroid/content/res/ColorStateList;
    ...
    invoke-interface {v0, p0}, Landroid/support/v4/widget/h$b;->d(Landroid/widget/ImageView;)Landroid/content/res/ColorStateList;
...
.method public static b(Landroid/widget/ImageView;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-interface {v0, p0}, Landroid/support/v4/widget/h$b;->a(Landroid/widget/ImageView;)Landroid/graphics/PorterDuff$Mode;
...
.method public static c(Landroid/widget/ImageView;Landroid/content/res/ColorStateList;)V
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v4/widget/h$b;->c(Landroid/widget/ImageView;Landroid/content/res/ColorStateList;)V
...
.method public static d(Landroid/widget/ImageView;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v4/widget/h$b;->b(Landroid/widget/ImageView;Landroid/graphics/PorterDuff$Mode;)V
