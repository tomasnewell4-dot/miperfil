...
# interfaces
.implements La/b/d/i/l;
.implements La/b/d/i/i;
...
.field C:Landroid/support/v4/widget/c;
...
.field private L:Landroid/support/v4/widget/SwipeRefreshLayout$i;
...
.field d:Landroid/support/v4/widget/SwipeRefreshLayout$j;
...
.field private final i:La/b/d/i/m;

.field private final j:La/b/d/i/j;
...
.field w:Landroid/support/v4/widget/b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p0, v2}, La/b/d/i/p;->K(Landroid/view/ViewGroup;Z)V
    ...
    new-instance v1, La/b/d/i/m;

    invoke-direct {v1, p0}, La/b/d/i/m;-><init>(Landroid/view/ViewGroup;)V

    iput-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->i:La/b/d/i/m;

    new-instance v1, La/b/d/i/j;

    invoke-direct {v1, p0}, La/b/d/i/j;-><init>(Landroid/view/View;)V

    iput-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:La/b/d/i/j;
    ...
    invoke-virtual {p0, v1}, Landroid/support/v4/widget/SwipeRefreshLayout;->o(F)V
...
.method private a(ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    iget-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Landroid/support/v4/widget/b;

    invoke-virtual {p1, p2}, Landroid/support/v4/widget/b;->b(Landroid/view/animation/Animation$AnimationListener;)V
...
.method private b(ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/v4/widget/SwipeRefreshLayout;->x(ILandroid/view/animation/Animation$AnimationListener;)V
...
.method private d()V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Landroid/support/v4/widget/b;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/c;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/support/v4/widget/c;->r(I)V

    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Landroid/support/v4/widget/b;

    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/c;
...
.method private e()V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Landroid/support/v4/widget/b;
...
.method private f(F)V
    ...
    invoke-direct {p0, p1, p1}, Landroid/support/v4/widget/SwipeRefreshLayout;->r(ZZ)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/c;

    const/4 v1, 0x0

    invoke-virtual {v0, v1, v1}, Landroid/support/v4/widget/c;->p(FF)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/c;->j(Z)V
...
.method private j(F)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/widget/c;->j(Z)V
    ...
    iget-boolean v4, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->K:Z
    ...
    iget-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/c;

    invoke-virtual {p1}, Landroid/support/v4/widget/c;->getAlpha()I
    ...
    invoke-direct {p0, p1}, Landroid/support/v4/widget/SwipeRefreshLayout;->g(Landroid/view/animation/Animation;)Z

    move-result p1

    if-nez p1, :cond_5

    invoke-direct {p0}, Landroid/support/v4/widget/SwipeRefreshLayout;->v()V
    ...
    invoke-direct {p0}, Landroid/support/v4/widget/SwipeRefreshLayout;->u()V
    ...
    iget-object v4, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/c;

    invoke-static {p1, v0}, Ljava/lang/Math;->min(FF)F

    move-result p1

    invoke-virtual {v4, v6, p1}, Landroid/support/v4/widget/c;->p(FF)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/widget/c;->k(F)V
    ...
    invoke-virtual {p1, v2}, Landroid/support/v4/widget/c;->m(F)V
...
.method private r(ZZ)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/SwipeRefreshLayout;->w(Landroid/view/animation/Animation$AnimationListener;)V
...
.method private u()V
    ...
    invoke-direct {p0, v0, v1}, Landroid/support/v4/widget/SwipeRefreshLayout;->s(II)Landroid/view/animation/Animation;
...
.method private y(Landroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/b;->b(Landroid/view/animation/Animation$AnimationListener;)V
...
.method public c()Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->L:Landroid/support/v4/widget/SwipeRefreshLayout$i;
    ...
    invoke-static {v0, v2}, Landroid/support/v4/widget/j;->a(Landroid/widget/ListView;I)Z
...
.method public dispatchNestedFling(FFZ)Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:La/b/d/i/j;

    invoke-virtual {v0, p1, p2, p3}, La/b/d/i/j;->a(FFZ)Z
...
.method public dispatchNestedPreFling(FF)Z
    ...
    invoke-virtual {v0, p1, p2}, La/b/d/i/j;->b(FF)Z
...
.method public dispatchNestedPreScroll(II[I[I)Z
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, La/b/d/i/j;->c(II[I[I)Z
...
.method public dispatchNestedScroll(IIII[I)Z
    ...
    invoke-virtual/range {v0 .. v5}, La/b/d/i/j;->e(IIII[I)Z
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->i:La/b/d/i/m;
...
.method public hasNestedScrollingParent()Z
    ...
    invoke-virtual {v0}, La/b/d/i/j;->h()Z
...
.method public isNestedScrollingEnabled()Z
    ...
    invoke-virtual {v0}, La/b/d/i/j;->j()Z
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {p0}, Landroid/support/v4/widget/SwipeRefreshLayout;->q()V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_2
    invoke-direct {p0, p1}, Landroid/support/v4/widget/SwipeRefreshLayout;->p(Landroid/view/MotionEvent;)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v4/widget/SwipeRefreshLayout;->t(F)V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Landroid/support/v4/widget/b;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Landroid/support/v4/widget/b;

    invoke-virtual {p2}, Landroid/widget/ImageView;->getMeasuredWidth()I

    move-result p2

    iget-object p3, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Landroid/support/v4/widget/b;

    invoke-virtual {p3}, Landroid/widget/ImageView;->getMeasuredHeight()I

    move-result p3

    iget-object p4, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->w:Landroid/support/v4/widget/b;
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2, p3}, La/b/d/i/m;->b(Landroid/view/View;Landroid/view/View;I)V
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, La/b/d/i/m;->d(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v4/widget/SwipeRefreshLayout;->f(F)V
...
.method public requestDisallowInterceptTouchEvent(Z)V
    ...
    invoke-static {v0}, La/b/d/i/p;->x(Landroid/view/View;)Z
...
.method public varargs setColorSchemeColors([I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/c;->l([I)V
...
.method public varargs setColorSchemeResources([I)V
    ...
    invoke-static {v0, v3}, La/b/d/b/a;->a(Landroid/content/Context;I)I
...
.method public setNestedScrollingEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, La/b/d/i/j;->k(Z)V
...
.method public setOnChildScrollUpCallback(Landroid/support/v4/widget/SwipeRefreshLayout$i;)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->L:Landroid/support/v4/widget/SwipeRefreshLayout$i;
...
.method public setOnRefreshListener(Landroid/support/v4/widget/SwipeRefreshLayout$j;)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->d:Landroid/support/v4/widget/SwipeRefreshLayout$j;
...
.method public setProgressBackgroundColorSchemeResource(I)V
    ...
    invoke-static {v0, p1}, La/b/d/b/a;->a(Landroid/content/Context;I)I
...
.method public setRefreshing(Z)V
    ...
    iget-boolean p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->K:Z
    ...
    invoke-direct {p0, p1}, Landroid/support/v4/widget/SwipeRefreshLayout;->y(Landroid/view/animation/Animation$AnimationListener;)V

    goto :goto_1

    :cond_1
    invoke-direct {p0, p1, v0}, Landroid/support/v4/widget/SwipeRefreshLayout;->r(ZZ)V
...
.method public setSize(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/c;->r(I)V
...
.method setTargetOffsetTopAndBottom(I)V
    ...
    invoke-static {v0, p1}, La/b/d/i/p;->A(Landroid/view/View;I)V
...
.method public startNestedScroll(I)Z
    ...
    invoke-virtual {v0, p1}, La/b/d/i/j;->m(I)Z
...
.method public stopNestedScroll()V
    ...
    invoke-virtual {v0}, La/b/d/i/j;->o()V
