...
.field private x:Landroid/support/v4/widget/NestedScrollView$c;

.field private final y:La/b/d/i/m;

.field private final z:La/b/d/i/j;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    new-instance p1, La/b/d/i/m;

    invoke-direct {p1, p0}, La/b/d/i/m;-><init>(Landroid/view/ViewGroup;)V

    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->y:La/b/d/i/m;

    new-instance p1, La/b/d/i/j;

    invoke-direct {p1, p0}, La/b/d/i/j;-><init>(Landroid/view/View;)V

    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->z:La/b/d/i/j;
...
.method private F(III)Z
    ...
    :goto_0
    invoke-direct {p0, v4, p2, p3}, Landroid/support/v4/widget/NestedScrollView;->p(ZII)Landroid/view/View;
...
.method private H(Landroid/graphics/Rect;Z)Z
    ...
    :cond_1
    invoke-virtual {p0, v0, p1}, Landroid/support/v4/widget/NestedScrollView;->I(II)V
...
.method private g(I)V
    ...
    invoke-virtual {p0, v1, p1}, Landroid/support/v4/widget/NestedScrollView;->I(II)V
...
.method private h()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/widget/NestedScrollView;->L(I)V
...
.method private r(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/NestedScrollView;->q(I)V
...
.method private static z(Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-static {p0, p1}, Landroid/support/v4/widget/NestedScrollView;->z(Landroid/view/View;Landroid/view/View;)Z
...
.method C(IIIIIIIIZ)Z
    ...
    invoke-virtual {p0, v5}, Landroid/support/v4/widget/NestedScrollView;->t(I)Z

    move-result v7

    if-nez v7, :cond_c

    iget-object v7, v0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/widget/OverScroller;
...
.method public D(I)Z
    ...
    invoke-direct {p0, p1, v1, v3}, Landroid/support/v4/widget/NestedScrollView;->F(III)Z
...
.method public final I(II)V
    ...
    iget-object p2, p0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/widget/OverScroller;
...
.method public final J(II)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/widget/NestedScrollView;->I(II)V
...
.method public K(II)Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->z:La/b/d/i/j;

    invoke-virtual {v0, p1, p2}, La/b/d/i/j;->n(II)Z
...
.method public L(I)V
    ...
    invoke-virtual {v0, p1}, La/b/d/i/j;->p(I)V
...
.method public computeScroll()V
    ...
    invoke-virtual/range {v0 .. v9}, Landroid/support/v4/widget/NestedScrollView;->C(IIIIIIIIZ)Z
    ...
    invoke-static/range {p0 .. p0}, La/b/d/i/p;->C(Landroid/view/View;)V

    goto :goto_4

    :cond_5
    invoke-virtual {v10, v12}, Landroid/support/v4/widget/NestedScrollView;->t(I)Z

    move-result v0

    if-eqz v0, :cond_6

    invoke-virtual {v10, v12}, Landroid/support/v4/widget/NestedScrollView;->L(I)V
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/NestedScrollView;->o(Landroid/view/KeyEvent;)Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v3, p0, Landroid/support/v4/widget/NestedScrollView;->f:Landroid/widget/EdgeEffect;
...
.method public e(II[I[II)Z
    ...
    invoke-virtual/range {v0 .. v5}, La/b/d/i/j;->d(II[I[II)Z
...
.method public f(IIII[II)Z
    ...
    invoke-virtual/range {v0 .. v6}, La/b/d/i/j;->f(IIII[II)Z
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->y:La/b/d/i/m;
...
.method public o(Landroid/view/KeyEvent;)Z
    ...
    :cond_6
    invoke-virtual {p0, v2}, Landroid/support/v4/widget/NestedScrollView;->s(I)Z
    ...
    :cond_8
    invoke-virtual {p0, v4}, Landroid/support/v4/widget/NestedScrollView;->s(I)Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_6
    invoke-virtual {p0, v3}, Landroid/support/v4/widget/NestedScrollView;->L(I)V
    ...
    invoke-direct {p0, v4, v0}, Landroid/support/v4/widget/NestedScrollView;->u(II)Z
    ...
    invoke-virtual {p0, v1, v3}, Landroid/support/v4/widget/NestedScrollView;->K(II)Z
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static {p2, p0}, Landroid/support/v4/widget/NestedScrollView;->z(Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-direct {p0, p2}, Landroid/support/v4/widget/NestedScrollView;->G(Landroid/view/View;)V
    ...
    iget-object p4, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/widget/NestedScrollView$c;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/widget/NestedScrollView$c;
    ...
    iput-object p2, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/widget/NestedScrollView$c;
...
.method public onNestedFling(Landroid/view/View;FFZ)Z
    ...
    invoke-direct {p0, p1}, Landroid/support/v4/widget/NestedScrollView;->r(I)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/widget/NestedScrollView$c;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v10, v13}, Landroid/support/v4/widget/NestedScrollView;->t(I)Z
    ...
    invoke-direct {v10, v0}, Landroid/support/v4/widget/NestedScrollView;->r(I)V
    ...
    invoke-virtual {v10, v1, v13}, Landroid/support/v4/widget/NestedScrollView;->K(II)Z
...
.method public q(I)V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/widget/NestedScrollView;->K(II)Z
...
.method public requestChildRectangleOnScreen(Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    invoke-direct {p0, p2, p3}, Landroid/support/v4/widget/NestedScrollView;->H(Landroid/graphics/Rect;Z)Z
...
.method public s(I)Z
    ...
    invoke-direct {p0, p1, v1, v0}, Landroid/support/v4/widget/NestedScrollView;->F(III)Z
...
.method public t(I)Z
    ...
    invoke-virtual {v0, p1}, La/b/d/i/j;->i(I)Z
