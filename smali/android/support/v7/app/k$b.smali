...
.method constructor <init>(Landroid/support/v7/app/k;Landroid/support/v7/app/s;)V
    ...
    invoke-virtual {p2}, Landroid/support/v7/app/s;->d()Z

    move-result p1

    iput-boolean p1, p0, Landroid/support/v7/app/k$b;->b:Z
...
.method final a()V
    ...
    iget-object v1, p0, Landroid/support/v7/app/k$b;->e:Landroid/support/v7/app/k;
...
.method final b()V
    ...
    iget-object v0, p0, Landroid/support/v7/app/k$b;->a:Landroid/support/v7/app/s;

    invoke-virtual {v0}, Landroid/support/v7/app/s;->d()Z

    move-result v0

    iget-boolean v1, p0, Landroid/support/v7/app/k$b;->b:Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/k;->d()Z
...
.method final d()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/k$b;->a()V

    iget-object v0, p0, Landroid/support/v7/app/k$b;->c:Landroid/content/BroadcastReceiver;

    if-nez v0, :cond_0

    new-instance v0, Landroid/support/v7/app/k$b$a;

    invoke-direct {v0, p0}, Landroid/support/v7/app/k$b$a;-><init>(Landroid/support/v7/app/k$b;)V

    iput-object v0, p0, Landroid/support/v7/app/k$b;->c:Landroid/content/BroadcastReceiver;

    :cond_0
    iget-object v0, p0, Landroid/support/v7/app/k$b;->d:Landroid/content/IntentFilter;
    ...
    iput-object v0, p0, Landroid/support/v7/app/k$b;->d:Landroid/content/IntentFilter;
    ...
    iget-object v0, v0, Landroid/support/v7/app/h;->f:Landroid/content/Context;

    iget-object v1, p0, Landroid/support/v7/app/k$b;->c:Landroid/content/BroadcastReceiver;

    iget-object v2, p0, Landroid/support/v7/app/k$b;->d:Landroid/content/IntentFilter;
