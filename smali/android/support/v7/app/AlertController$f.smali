...
.field public L:Landroid/support/v7/app/AlertController$f$e;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/app/AlertController$f;->M:Z
...
.method private b(Landroid/support/v7/app/AlertController;)V
    ...
    :goto_1
    iget-object v1, p0, Landroid/support/v7/app/AlertController$f;->L:Landroid/support/v7/app/AlertController$f$e;
    ...
    :cond_7
    :goto_3
    iget-object v1, p0, Landroid/support/v7/app/AlertController$f;->K:Landroid/widget/AdapterView$OnItemSelectedListener;
...
.method public a(Landroid/support/v7/app/AlertController;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/app/AlertController;->k(Landroid/view/View;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/app/AlertController;->p(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/app/AlertController;->m(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/app/AlertController;->l(I)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/app/AlertController;->n(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v2, v0, v3, v1}, Landroid/support/v7/app/AlertController;->j(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;Landroid/os/Message;)V
    ...
    invoke-virtual/range {v1 .. v6}, Landroid/support/v7/app/AlertController;->s(Landroid/view/View;IIII)V

    goto :goto_1

    :cond_b
    invoke-virtual {p1, v2}, Landroid/support/v7/app/AlertController;->r(Landroid/view/View;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/app/AlertController;->q(I)V
