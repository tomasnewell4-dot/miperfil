...
.method constructor <init>(Landroid/support/v7/widget/Toolbar;Ljava/lang/CharSequence;Landroid/view/Window$Callback;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/app/q$a;-><init>(Landroid/support/v7/app/q;)V

    iput-object v0, p0, Landroid/support/v7/app/q;->g:Ljava/lang/Runnable;

    new-instance v0, Landroid/support/v7/app/q$b;

    invoke-direct {v0, p0}, Landroid/support/v7/app/q$b;-><init>(Landroid/support/v7/app/q;)V

    iput-object v0, p0, Landroid/support/v7/app/q;->h:Landroid/support/v7/widget/Toolbar$f;
    ...
    iput-object v1, p0, Landroid/support/v7/app/q;->a:Landroid/support/v7/widget/e0;

    new-instance v1, Landroid/support/v7/app/q$e;

    invoke-direct {v1, p0, p3}, Landroid/support/v7/app/q$e;-><init>(Landroid/support/v7/app/q;Landroid/view/Window$Callback;)V

    iput-object v1, p0, Landroid/support/v7/app/q;->c:Landroid/view/Window$Callback;

    iget-object p3, p0, Landroid/support/v7/app/q;->a:Landroid/support/v7/widget/e0;
    ...
    iget-object p1, p0, Landroid/support/v7/app/q;->a:Landroid/support/v7/widget/e0;
...
.method private z()Landroid/view/Menu;
    ...
    iget-object v0, p0, Landroid/support/v7/app/q;->a:Landroid/support/v7/widget/e0;

    new-instance v1, Landroid/support/v7/app/q$c;

    invoke-direct {v1, p0}, Landroid/support/v7/app/q$c;-><init>(Landroid/support/v7/app/q;)V

    new-instance v2, Landroid/support/v7/app/q$d;

    invoke-direct {v2, p0}, Landroid/support/v7/app/q$d;-><init>(Landroid/support/v7/app/q;)V

    invoke-interface {v0, v1, v2}, Landroid/support/v7/widget/e0;->j(Landroid/support/v7/view/menu/o$a;Landroid/support/v7/view/menu/h$a;)V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/e0;->o()Landroid/view/Menu;
...
.method B()V
    ...
    invoke-direct {p0}, Landroid/support/v7/app/q;->z()Landroid/view/Menu;
    ...
    invoke-virtual {v1}, Landroid/support/v7/view/menu/h;->g0()V

    :cond_1
    :try_start_0
    invoke-interface {v0}, Landroid/view/Menu;->clear()V

    iget-object v3, p0, Landroid/support/v7/app/q;->c:Landroid/view/Window$Callback;
...
.method public C(II)V
    ...
    iget-object v1, p0, Landroid/support/v7/app/q;->a:Landroid/support/v7/widget/e0;
...
.method public l()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/e0;->r()Landroid/view/ViewGroup;
    ...
    invoke-static {v0, v1}, La/b/d/i/p;->D(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public m(Landroid/content/res/Configuration;)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/app/a;->m(Landroid/content/res/Configuration;)V
...
.method public p(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/q;->q()Z
...
.method public s(Z)V
    ...
    :goto_0
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/app/q;->C(II)V
