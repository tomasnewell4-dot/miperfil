...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;Z)V
    ...
    sget v0, La/b/e/a/h;->a:I

    sget v1, La/b/e/a/e;->l:I
...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;ZII)V
    ...
    sget-object v1, La/b/e/a/j;->a:[I

    sget v2, La/b/e/a/a;->c:I

    invoke-static {p1, v0, v1, v2, p4}, Landroid/support/v7/widget/h1;->t(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/h1;

    move-result-object p1

    sget v0, La/b/e/a/j;->l:I
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/i1;->D(Landroid/graphics/drawable/Drawable;)V

    :cond_3
    sget p2, La/b/e/a/j;->m:I
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/i1;->v(Landroid/graphics/drawable/Drawable;)V

    :cond_5
    sget p2, La/b/e/a/j;->h:I

    invoke-virtual {p1, p2, p4}, Landroid/support/v7/widget/h1;->j(II)I

    move-result p2

    invoke-virtual {p0, p2}, Landroid/support/v7/widget/i1;->y(I)V

    sget p2, La/b/e/a/j;->g:I
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/i1;->B(Landroid/view/View;)V
    ...
    :cond_c
    invoke-direct {p0}, Landroid/support/v7/widget/i1;->A()I
    ...
    invoke-virtual {p0, p3}, Landroid/support/v7/widget/i1;->C(I)V
...
.method private A()I
    ...
    iput-object v1, p0, Landroid/support/v7/widget/i1;->q:Landroid/graphics/drawable/Drawable;
...
.method public C(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/i1;->s(I)V
...
.method public f(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
    ...
    sget v1, La/b/e/a/f;->g:I

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/b;->s(I)V

    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/i1;->n:Landroid/support/v7/widget/d;

    invoke-virtual {v0, p2}, Landroid/support/v7/view/menu/b;->l(Landroid/support/v7/view/menu/o$a;)V
    ...
    invoke-virtual {p2, p1, v0}, Landroid/support/v7/widget/Toolbar;->H(Landroid/support/v7/view/menu/h;Landroid/support/v7/widget/d;)V
...
.method public i(Landroid/support/v7/widget/z0;)V
    .locals 2
...
.method public j(Landroid/support/v7/view/menu/o$a;Landroid/support/v7/view/menu/h$a;)V
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/i1;->a:Landroid/support/v7/widget/Toolbar;

    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/Toolbar;->I(Landroid/support/v7/view/menu/o$a;Landroid/support/v7/view/menu/h$a;)V

    return-void
.end method

.method public k(IJ)La/b/d/i/t;
    .locals 2
    ...
    invoke-virtual {v0, p2, p3}, La/b/d/i/t;->d(J)La/b/d/i/t;
    ...
    invoke-virtual {p2, p3}, La/b/d/i/t;->f(La/b/d/i/u;)La/b/d/i/t;
...
.method public q(I)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/i1;->x()Landroid/content/Context;
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/i1;->D(Landroid/graphics/drawable/Drawable;)V
...
.method public s(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/i1;->E(Ljava/lang/CharSequence;)V
