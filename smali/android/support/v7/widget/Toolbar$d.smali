...
.method public f(Landroid/support/v7/view/menu/h;Landroid/support/v7/view/menu/j;)Z
    ...
    iput-object p2, p0, Landroid/support/v7/widget/Toolbar$d;->b:Landroid/support/v7/view/menu/j;
    ...
    invoke-virtual {p2, p1}, Landroid/support/v7/view/menu/j;->q(Z)V
    ...
    instance-of v0, p2, La/b/e/e/c;

    if-eqz v0, :cond_2

    check-cast p2, La/b/e/e/c;

    invoke-interface {p2}, La/b/e/e/c;->a()V
...
.method public j(Landroid/support/v7/view/menu/h;Landroid/support/v7/view/menu/j;)Z
    ...
    instance-of v0, p1, La/b/e/e/c;

    if-eqz v0, :cond_0

    check-cast p1, La/b/e/e/c;

    invoke-interface {p1}, La/b/e/e/c;->f()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar$d;->b:Landroid/support/v7/view/menu/j;
...
.method public k(Z)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/Toolbar$d;->b:Landroid/support/v7/view/menu/j;

    if-eqz p1, :cond_2

    iget-object p1, p0, Landroid/support/v7/widget/Toolbar$d;->a:Landroid/support/v7/view/menu/h;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/Toolbar$d;->a:Landroid/support/v7/view/menu/h;

    invoke-virtual {v2, v1}, Landroid/support/v7/view/menu/h;->getItem(I)Landroid/view/MenuItem;

    move-result-object v2

    iget-object v3, p0, Landroid/support/v7/widget/Toolbar$d;->b:Landroid/support/v7/view/menu/j;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar$d;->b:Landroid/support/v7/view/menu/j;

    invoke-virtual {p0, p1, v0}, Landroid/support/v7/widget/Toolbar$d;->j(Landroid/support/v7/view/menu/h;Landroid/support/v7/view/menu/j;)Z
...
.method public n(Landroid/content/Context;Landroid/support/v7/view/menu/h;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/view/menu/h;->f(Landroid/support/v7/view/menu/j;)Z

    :cond_0
    iput-object p2, p0, Landroid/support/v7/widget/Toolbar$d;->a:Landroid/support/v7/view/menu/h;
