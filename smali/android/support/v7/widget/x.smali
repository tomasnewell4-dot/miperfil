...
.field private d:Landroid/support/v7/widget/k0;

.field private e:Landroid/widget/SpinnerAdapter;

.field private final f:Z

.field private g:Landroid/support/v7/widget/x$c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    sget-object v0, La/b/e/a/j;->b2:[I
    ...
    iput-object v2, p0, Landroid/support/v7/widget/x;->b:Landroid/support/v7/widget/g;

    const/4 v2, 0x0

    if-eqz p5, :cond_0

    new-instance v3, La/b/e/e/d;

    invoke-direct {v3, p1, p5}, La/b/e/e/d;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-direct {v3, p1, p5}, La/b/e/e/d;-><init>(Landroid/content/Context;I)V
    ...
    :goto_1
    iput-object p5, p0, Landroid/support/v7/widget/x;->c:Landroid/content/Context;

    :goto_2
    iget-object p5, p0, Landroid/support/v7/widget/x;->c:Landroid/content/Context;
    ...
    :try_start_0
    sget-object p5, Landroid/support/v7/widget/x;->a:[I
    ...
    sget-object v4, La/b/e/a/j;->b2:[I
    ...
    iput-object p4, p0, Landroid/support/v7/widget/x;->g:Landroid/support/v7/widget/x$c;
    ...
    iput-object p5, p0, Landroid/support/v7/widget/x;->d:Landroid/support/v7/widget/k0;

    :cond_7
    sget p4, La/b/e/a/j;->c2:I
    ...
    :cond_9
    iget-object p1, p0, Landroid/support/v7/widget/x;->b:Landroid/support/v7/widget/g;
...
.method static synthetic a(Landroid/support/v7/widget/x;)Landroid/support/v7/widget/x$c;
    ...
    iget-object p0, p0, Landroid/support/v7/widget/x;->g:Landroid/support/v7/widget/x$c;
...
.method public getDropDownHorizontalOffset()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->g:Landroid/support/v7/widget/x$c;
...
.method protected onMeasure(II)V
    ...
    iget-object p2, p0, Landroid/support/v7/widget/x;->g:Landroid/support/v7/widget/x$c;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->d:Landroid/support/v7/widget/k0;
...
.method public performClick()Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/x$c;->g()V
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/x;->g:Landroid/support/v7/widget/x$c;
