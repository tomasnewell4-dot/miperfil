...
.method private e()Landroid/view/View;
    ...
    check-cast v3, Landroid/support/v7/widget/u0$o;

    invoke-virtual {v3}, Landroid/support/v7/widget/u0$o;->c()Z
    ...
    invoke-virtual {v3}, Landroid/support/v7/widget/u0$o;->a()I
...
.method public b(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/LinearLayoutManager$c;->f(Landroid/view/View;)Landroid/view/View;
...
.method c(Landroid/support/v7/widget/u0$z;)Z
    .locals 1
...
.method d(Landroid/support/v7/widget/u0$u;)Landroid/view/View;
    .locals 2
    ...
    invoke-direct {p0}, Landroid/support/v7/widget/LinearLayoutManager$c;->e()Landroid/view/View;
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/u0$u;->o(I)Landroid/view/View;
...
.method public f(Landroid/view/View;)Landroid/view/View;
    ...
    iget-object v4, v4, Landroid/support/v7/widget/u0$c0;->b:Landroid/view/View;

    invoke-virtual {v4}, Landroid/view/View;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;

    move-result-object v5

    check-cast v5, Landroid/support/v7/widget/u0$o;

    if-eq v4, p1, :cond_3

    invoke-virtual {v5}, Landroid/support/v7/widget/u0$o;->c()Z
    ...
    :cond_0
    invoke-virtual {v5}, Landroid/support/v7/widget/u0$o;->a()I
