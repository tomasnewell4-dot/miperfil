...
.field private u:Landroid/support/v7/view/menu/o$a;

.field v:Landroid/support/v7/view/menu/h$a;
...
.method private M(II)V
    ...
    invoke-virtual {v3}, Landroid/support/v7/view/menu/ActionMenuItemView;->d()Z
    ...
    :goto_3
    invoke-static {v11, v4, v3, v6, v5}, Landroid/support/v7/widget/ActionMenuView;->L(Landroid/view/View;IIII)I
...
.method protected C()Landroid/support/v7/widget/ActionMenuView$c;
    .locals 2
...
.method public D(Landroid/util/AttributeSet;)Landroid/support/v7/widget/ActionMenuView$c;
    .locals 2
...
.method protected E(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/ActionMenuView$c;
    .locals 1
    ...
    :cond_2
    invoke-virtual {p0}, Landroid/support/v7/widget/ActionMenuView;->C()Landroid/support/v7/widget/ActionMenuView$c;
...
.method public F()Landroid/support/v7/widget/ActionMenuView$c;
    .locals 2
...
.method protected G(I)Z
    ...
    invoke-interface {v2}, Landroid/support/v7/widget/ActionMenuView$a;->a()Z
...
.method public N()Landroid/support/v7/view/menu/h;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->p:Landroid/support/v7/view/menu/h;

    return-object v0
.end method

.method public O(Landroid/support/v7/view/menu/o$a;Landroid/support/v7/view/menu/h$a;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->u:Landroid/support/v7/view/menu/o$a;

    iput-object p2, p0, Landroid/support/v7/widget/ActionMenuView;->v:Landroid/support/v7/view/menu/h$a;
...
.method public b(Landroid/support/v7/view/menu/h;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->p:Landroid/support/v7/view/menu/h;
...
.method public d(Landroid/support/v7/view/menu/j;)Z
    ...
    invoke-virtual {v0, p1, v1}, Landroid/support/v7/view/menu/h;->M(Landroid/view/MenuItem;I)Z
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ActionMenuView;->D(Landroid/util/AttributeSet;)Landroid/support/v7/widget/ActionMenuView$c;
...
.method protected bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ActionMenuView;->E(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/ActionMenuView$c;
...
.method public getMenu()Landroid/view/Menu;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->p:Landroid/support/v7/view/menu/h;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/view/menu/h;->U(Landroid/support/v7/view/menu/h$a;)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/d;->L(Z)V

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->t:Landroid/support/v7/widget/d;

    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->u:Landroid/support/v7/view/menu/o$a;
    ...
    :goto_0
    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/b;->l(Landroid/support/v7/view/menu/o$a;)V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/view/menu/h;->c(Landroid/support/v7/view/menu/o;Landroid/content/Context;)V

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->t:Landroid/support/v7/widget/d;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/d;->J(Landroid/support/v7/widget/ActionMenuView;)V
...
.method protected bridge synthetic m()Landroid/support/v7/widget/n0$a;
    .locals 1
...
.method public bridge synthetic n(Landroid/util/AttributeSet;)Landroid/support/v7/widget/n0$a;
    .locals 0
...
.method protected bridge synthetic o(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/n0$a;
    .locals 0
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p1}, Landroid/support/v7/widget/d;->M()Z
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v0, v8}, Landroid/support/v7/widget/ActionMenuView;->G(I)Z
...
.method protected onMeasure(II)V
    ...
    iput v3, p0, Landroid/support/v7/widget/ActionMenuView;->x:I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->p:Landroid/support/v7/view/menu/h;

    if-eqz v1, :cond_2

    iget v4, p0, Landroid/support/v7/widget/ActionMenuView;->x:I

    if-eq v0, v4, :cond_2

    iput v0, p0, Landroid/support/v7/widget/ActionMenuView;->x:I

    invoke-virtual {v1, v2}, Landroid/support/v7/view/menu/h;->L(Z)V
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/ActionMenuView;->M(II)V
...
.method public setExpandedActionViewsExclusive(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/d;->I(Z)V
...
.method public setOverflowIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/d;->K(Landroid/graphics/drawable/Drawable;)V
...
.method public setPresenter(Landroid/support/v7/widget/d;)V
    ...
    invoke-virtual {p1, p0}, Landroid/support/v7/widget/d;->J(Landroid/support/v7/widget/ActionMenuView;)V
