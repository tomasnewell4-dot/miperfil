...
.field private final C:La/b/d/i/m;
...
.field private f:Landroid/support/v7/widget/e0;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:I
    ...
    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->z:Landroid/animation/AnimatorListenerAdapter;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->C:La/b/d/i/m;
...
.method private p(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
    .locals 2
...
.method private s(Landroid/view/View;)Landroid/support/v7/widget/e0;
    .locals 3
...
.method public a()Z
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->y()V

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->f:Landroid/support/v7/widget/e0;
...
.method public c()V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/e0;->c()V
...
.method public f(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
    .locals 1
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/e0;->f(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0}, La/b/d/i/p;->p(Landroid/view/View;)I
    ...
    invoke-direct/range {v1 .. v7}, Landroid/support/v7/widget/ActionBarOverlayLayout;->p(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
    ...
    invoke-static {p0, p1, v1}, Landroid/support/v7/widget/p1;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method protected bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->q()Landroid/support/v7/widget/ActionBarOverlayLayout$e;
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ActionBarOverlayLayout;->r(Landroid/util/AttributeSet;)Landroid/support/v7/widget/ActionBarOverlayLayout$e;
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->C:La/b/d/i/m;
...
.method public h(I)V
    ...
    :cond_1
    iget-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->f:Landroid/support/v7/widget/e0;

    invoke-interface {p1}, Landroid/support/v7/widget/e0;->u()V
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/e0;->n()V
...
.method protected onMeasure(II)V
    ...
    invoke-direct/range {v6 .. v12}, Landroid/support/v7/widget/ActionBarOverlayLayout;->p(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
...
.method public onNestedFling(Landroid/view/View;FFZ)Z
    ...
    :cond_1
    invoke-direct {p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->z()V
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    invoke-direct {p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->x()V

    goto :goto_0

    :cond_0
    invoke-direct {p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->w()V
...
.method public onWindowSystemUiVisibilityChanged(I)V
    ...
    invoke-interface {p1, v3}, Landroid/support/v7/widget/ActionBarOverlayLayout$d;->b(Z)V
...
.method protected onWindowVisibilityChanged(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/ActionBarOverlayLayout$d;->c(I)V

    :cond_0
    return-void
.end method

.method protected q()Landroid/support/v7/widget/ActionBarOverlayLayout$e;
    .locals 2
...
.method public r(Landroid/util/AttributeSet;)Landroid/support/v7/widget/ActionBarOverlayLayout$e;
    .locals 2
...
.method public setActionBarVisibilityCallback(Landroid/support/v7/widget/ActionBarOverlayLayout$d;)V
    ...
    invoke-interface {p1, v0}, Landroid/support/v7/widget/ActionBarOverlayLayout$d;->c(I)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/e0;->q(I)V
...
.method t()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/view/ViewPropertyAnimator;
...
.method y()V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->s(Landroid/view/View;)Landroid/support/v7/widget/e0;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->f:Landroid/support/v7/widget/e0;
