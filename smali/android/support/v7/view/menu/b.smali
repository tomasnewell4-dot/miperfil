...
.field protected i:Landroid/support/v7/view/menu/p;
...
.method public abstract e(Landroid/support/v7/view/menu/j;Landroid/support/v7/view/menu/p$a;)V
.end method
...
.method public g(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/p$a;
    .locals 3
...
.method public k(Z)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/h;->t()V
    ...
    invoke-virtual {p0, v4, v5}, Landroid/support/v7/view/menu/b;->t(ILandroid/support/v7/view/menu/j;)Z
    ...
    :goto_1
    invoke-virtual {p0, v5, v6, p1}, Landroid/support/v7/view/menu/b;->q(Landroid/support/v7/view/menu/j;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, p1, v1}, Landroid/support/v7/view/menu/b;->o(Landroid/view/ViewGroup;I)Z
...
.method public p()Landroid/support/v7/view/menu/o$a;
    .locals 1
...
.method public q(Landroid/support/v7/view/menu/j;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_0
    invoke-virtual {p0, p3}, Landroid/support/v7/view/menu/b;->g(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/p$a;

    move-result-object p2

    :goto_0
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/view/menu/b;->e(Landroid/support/v7/view/menu/j;Landroid/support/v7/view/menu/p$a;)V
...
.method public r(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/p;
    ...
    invoke-interface {p1, v0}, Landroid/support/v7/view/menu/p;->b(Landroid/support/v7/view/menu/h;)V

    const/4 p1, 0x1

    invoke-virtual {p0, p1}, Landroid/support/v7/view/menu/b;->k(Z)V
...
.method public abstract t(ILandroid/support/v7/view/menu/j;)Z
.end method
