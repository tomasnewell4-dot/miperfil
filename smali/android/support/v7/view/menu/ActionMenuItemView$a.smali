...
.method protected c()Z
    ...
    iget-object v1, v0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Landroid/support/v7/view/menu/h$b;

    const/4 v2, 0x0

    if-eqz v1, :cond_0

    iget-object v0, v0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Landroid/support/v7/view/menu/j;

    invoke-interface {v1, v0}, Landroid/support/v7/view/menu/h$b;->d(Landroid/support/v7/view/menu/j;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Landroid/support/v7/view/menu/ActionMenuItemView$a;->b()Landroid/support/v7/view/menu/s;
