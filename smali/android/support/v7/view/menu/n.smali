...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/h;Landroid/view/View;ZII)V
    ...
    new-instance v0, Landroid/support/v7/view/menu/n$a;

    invoke-direct {v0, p0}, Landroid/support/v7/view/menu/n$a;-><init>(Landroid/support/v7/view/menu/n;)V
...
.method private a()Landroid/support/v7/view/menu/m;
    .locals 14
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/m;->o(Landroid/support/v7/view/menu/h;)V

    iget-object v1, p0, Landroid/support/v7/view/menu/n;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/m;->x(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroid/support/v7/view/menu/n;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/m;->s(Landroid/view/View;)V

    iget-object v1, p0, Landroid/support/v7/view/menu/n;->i:Landroid/support/v7/view/menu/o$a;

    invoke-interface {v0, v1}, Landroid/support/v7/view/menu/o;->l(Landroid/support/v7/view/menu/o$a;)V

    iget-boolean v1, p0, Landroid/support/v7/view/menu/n;->h:Z

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/m;->u(Z)V

    iget v1, p0, Landroid/support/v7/view/menu/n;->g:I

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/m;->v(I)V
...
.method private l(IIZZ)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/view/menu/n;->c()Landroid/support/v7/view/menu/m;

    move-result-object v0

    invoke-virtual {v0, p4}, Landroid/support/v7/view/menu/m;->y(Z)V
    ...
    invoke-static {p4}, La/b/d/i/p;->i(Landroid/view/View;)I

    move-result p4

    invoke-static {p3, p4}, La/b/d/i/d;->b(II)I
    ...
    :cond_0
    invoke-virtual {v0, p1}, Landroid/support/v7/view/menu/m;->w(I)V

    invoke-virtual {v0, p2}, Landroid/support/v7/view/menu/m;->z(I)V
    ...
    invoke-virtual {v0, p4}, Landroid/support/v7/view/menu/m;->t(Landroid/graphics/Rect;)V

    :cond_1
    invoke-interface {v0}, Landroid/support/v7/view/menu/s;->g()V
...
.method public b()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/view/menu/n;->d()Z
...
.method public c()Landroid/support/v7/view/menu/m;
    ...
    invoke-direct {p0}, Landroid/support/v7/view/menu/n;->a()Landroid/support/v7/view/menu/m;
...
.method public d()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/view/menu/s;->c()Z
...
.method public g(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/view/menu/m;->u(Z)V
...
.method public j(Landroid/support/v7/view/menu/o$a;)V
    .locals 1
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/view/menu/o;->l(Landroid/support/v7/view/menu/o$a;)V
...
.method public k()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/view/menu/n;->m()Z
...
.method public m()Z
    ...
    :cond_1
    invoke-direct {p0, v2, v2, v2, v2}, Landroid/support/v7/view/menu/n;->l(IIZZ)V
...
.method public n(II)Z
    ...
    :cond_1
    invoke-direct {p0, p1, p2, v1, v1}, Landroid/support/v7/view/menu/n;->l(IIZZ)V
