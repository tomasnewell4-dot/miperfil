...
.method public b(Landroid/support/v7/view/menu/u;)Z
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/i;->d(Landroid/os/IBinder;)V
...
.method public e(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/p;
    .locals 3
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/f;->i:Landroid/support/v7/view/menu/f$a;
...
.method public i()Landroid/os/Parcelable;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/view/menu/f;->o(Landroid/os/Bundle;)V
...
.method public m(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/view/menu/f;->g(Landroid/os/Bundle;)V
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    invoke-virtual {p2, p3}, Landroid/support/v7/view/menu/f$a;->b(I)Landroid/support/v7/view/menu/j;

    move-result-object p2

    const/4 p3, 0x0

    invoke-virtual {p1, p2, p0, p3}, Landroid/support/v7/view/menu/h;->N(Landroid/view/MenuItem;Landroid/support/v7/view/menu/o;I)Z
