...
.field private q:Landroid/support/design/widget/AppBarLayout$Behavior$b;
...
.method private Z(Landroid/support/design/widget/AppBarLayout;I)I
    ...
    invoke-static {v4}, La/b/d/i/p;->j(Landroid/view/View;)I
    ...
    :cond_0
    invoke-static {v4}, La/b/d/i/p;->g(Landroid/view/View;)Z
...
.method private l0(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)V
    ...
    invoke-static {v2}, La/b/d/i/p;->j(Landroid/view/View;)I
    ...
    invoke-static {v4, v0, v1}, La/b/d/e/a;->a(III)I
...
.method private m0(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;IIZ)V
    ...
    :cond_1
    :goto_1
    invoke-virtual {p2, v3}, Landroid/support/design/widget/AppBarLayout;->i(Z)Z
...
.method public bridge synthetic D()I
    ...
    invoke-super {p0}, Landroid/support/design/widget/p;->D()I
...
.method public bridge synthetic F(I)Z
    ...
    invoke-super {p0, p1}, Landroid/support/design/widget/p;->F(I)Z
...
.method T(Landroid/support/design/widget/AppBarLayout;)Z
    ...
    iget-object p1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->q:Landroid/support/design/widget/AppBarLayout$Behavior$b;
...
.method public b0(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;I)Z
    ...
    invoke-virtual {p0, p1, p2, v1}, Landroid/support/design/widget/i;->O(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)I
    ...
    :cond_3
    invoke-virtual {p0, p1, p2, v0}, Landroid/support/design/widget/i;->O(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)I
    ...
    :cond_5
    invoke-virtual {p0, p1, p2, v2}, Landroid/support/design/widget/i;->O(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)I

    :cond_6
    :goto_2
    invoke-virtual {p2}, Landroid/support/design/widget/AppBarLayout;->h()V
    ...
    invoke-static {v0, v1, v2}, La/b/d/e/a;->a(III)I
...
.method public d0(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/view/View;II[II)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/design/widget/i;->N(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;III)I
...
.method public f0(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/os/Parcelable;)V
    ...
    instance-of v0, p3, Landroid/support/design/widget/AppBarLayout$Behavior$c;

    if-eqz v0, :cond_0

    check-cast p3, Landroid/support/design/widget/AppBarLayout$Behavior$c;
    ...
    iget p1, p3, Landroid/support/design/widget/AppBarLayout$Behavior$c;->c:I

    iput p1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->m:I

    iget p1, p3, Landroid/support/design/widget/AppBarLayout$Behavior$c;->d:F

    iput p1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->o:F

    iget-boolean p1, p3, Landroid/support/design/widget/AppBarLayout$Behavior$c;->e:Z
...
.method public g0(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)Landroid/os/Parcelable;
    ...
    new-instance v0, Landroid/support/design/widget/AppBarLayout$Behavior$c;

    invoke-direct {v0, p1}, Landroid/support/design/widget/AppBarLayout$Behavior$c;-><init>(Landroid/os/Parcelable;)V

    iput v3, v0, Landroid/support/design/widget/AppBarLayout$Behavior$c;->c:I
    ...
    :cond_0
    iput-boolean v2, v0, Landroid/support/design/widget/AppBarLayout$Behavior$c;->e:Z
    ...
    iput p1, v0, Landroid/support/design/widget/AppBarLayout$Behavior$c;->d:F
...
.method j0(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;III)I
    ...
    invoke-static {p3, p4, p5}, La/b/d/e/a;->a(III)I
    ...
    invoke-virtual {p1, p2}, Landroid/support/design/widget/CoordinatorLayout;->e(Landroid/view/View;)V
